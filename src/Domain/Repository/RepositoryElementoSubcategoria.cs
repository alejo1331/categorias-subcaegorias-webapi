...
namespace Domain.Repository
{
    public class RepositoryElementoSubcategoria : InterfaceElementoSubcategoria<ElementoSubcategoria>
    {
        ...
        public ElementoSubcategoria GetSedeElectronicaId(int id, int padre)
        {
            ...
            return context.ElementoSubcategorias.Where(s => s.elementoId == id && s.tipoElementoId == elemento.id && s.codigoEstado == 1 && s.subcategoriaId == padre).FirstOrDefault();
        }
        ...
        {
            var elemento = this.context.TipoElementos.Where(s => s.sigla == "VU").FirstOrDefault();
            var vinculadas = this.context.ElementoSubcategorias.Where(s => s.subcategoriaId == id && s.tipoElementoId == elemento.id && s.codigoEstado == 1).Select(s => s.elementoId).ToList();
            ...
            if(tipo == 1)
            {
                ...
                if(orden == 1)
                {
                    if(!ascd)
                    {
                        VentanillaUnicas = this.context.VentanillaUnicas.Where(s => vinculadas.Contains(s.id) && s.codigoEstado == 1 && s.id == idFiltro)
                                                                        .OrderBy(s => s.id)
                                                                        .Skip((page - 1) * size)
                                                                        .Take(size)
                                                                        .ToList();
            ...
            else if(tipo == 2)
            {
                ...
                if(orden == 1)
                {
                    if(!ascd)
                    {
                        VentanillaUnicas = this.context.VentanillaUnicas.Where(s => vinculadas.Contains(s.id) && s.codigoEstado == 1 && s.nombre.Contains(filtro))
                                                                        .OrderBy(s => s.id)
                                                                        .Skip((page - 1) * size)
                                                                        .Take(size)
                                                                        .ToList();
            ...
            else
            {
                if(orden == 1)
                {
                    if(!ascd)
                    {
                        VentanillaUnicas = this.context.VentanillaUnicas.Where(s => vinculadas.Contains(s.id) && s.codigoEstado == 1 )
                                                                        .OrderBy(s => s.id)
                                                                        .Skip((page - 1) * size)
                                                                        .Take(size)
                                                                        .ToList();
        ...
        public long VincularVentanillaUnicaTotal(int id, int tipo, string filtro)
        {
            ...
            if(tipo == 1)
            {
                ...
                contador = this.context.VentanillaUnicas.Count(s => !vinculadas.Contains(s.id) && s.codigoEstado == 1 && s.id == idFiltro);
            }
            else if(tipo == 2)
            {
                contador = this.context.VentanillaUnicas.Count(s => !vinculadas.Contains(s.id) && s.codigoEstado == 1 && s.nombre.Contains(filtro));
            }
            else
            {
                 contador = this.context.VentanillaUnicas.Count(s => !vinculadas.Contains(s.id) && s.codigoEstado == 1);
            }
            return contador;
        }
        ...
        public IList<SedeElectronica> VinculadasSedeElectronica(int id, int page, int size, int orden, bool ascd, int tipo, string filtro)
        {
            ...
            if(tipo == 1)
            {
                ...
                if(orden == 1)
                {
                    if(!ascd)
                    {
                        SedeElectronicas = this.context.SedeElectronicas.Where(s => vinculadas.Contains(s.id) && s.codigoEstado == 1 && s.id == idFiltro)
                                                    .OrderBy(s => s.id)
                                                    .Skip((page - 1) * size)
                                                    .Take(size)
                                                    .ToList();
            ...
            else if(tipo == 2)
            {
                if(orden == 1)
                {
                    if(!ascd)
                    {
                        SedeElectronicas = this.context.SedeElectronicas.Where(s => vinculadas.Contains(s.id) && s.codigoEstado == 1 && s.nombre.Contains(filtro))
                                                    .OrderBy(s => s.id)
                                                    .Skip((page - 1) * size)
                                                    .Take(size)
                                                    .ToList();
            ...
            else
            {
                if(orden == 1)
                {
                    if(!ascd)
                    {
                        SedeElectronicas = this.context.SedeElectronicas.Where(s => vinculadas.Contains(s.id) && s.codigoEstado == 1)
                                                    .OrderBy(s => s.id)
                                                    .Skip((page - 1) * size)
                                                    .Take(size)
                                                    .ToList();
        ...
        public long VincularSedeElectronicaTotal(int id, int tipo, string filtro)
        {
            ...
            {
                int idFiltro = int.Parse(filtro);
                contador = this.context.SedeElectronicas.Count(s => !vinculadas.Contains(s.id) && s.codigoEstado == 1 && s.id == idFiltro);
            }
            else if(tipo == 2)
            {
                contador = this.context.SedeElectronicas.Count(s => !vinculadas.Contains(s.id) && s.codigoEstado == 1 && s.nombre.Contains(filtro));
            }
            else
            {
                contador = this.context.SedeElectronicas.Count(s => !vinculadas.Contains(s.id) && s.codigoEstado == 1);
            }
            return contador;
        }
        ...
        {
            var elemento = this.context.TipoElementos.Where(s => s.sigla == "TS").FirstOrDefault();
            var vinculadas = this.context.ElementoSubcategorias.Where(s => s.subcategoriaId == id && s.tipoElementoId == elemento.id && s.codigoEstado == 1).Select(s => s.elementoId.ToString()).ToList();
        ...
        public IList<PortalTransversal> VincularPortalTransversal(int id, int page, int size, int orden, bool ascd, int tipo, string filtro)
        {
            ...
            if(tipo == 1)
            {
                ...
                if(orden == 1)
                {
                    if(!ascd)
                    {
                        lista = this.context.PortalTransversals.Where(s => !vinculadas.Contains(s.id) && s.codigoEstado == 1 && s.id == idFiltro)
                                                .OrderBy(s => s.id)
                                                .Skip((page - 1) * size)
                                                .Take(size)
                                                .ToList();
            ...
            else if(tipo == 2)
            {
                if(orden == 1)
                {
                    if(!ascd)
                    {
                        lista = this.context.PortalTransversals.Where(s => !vinculadas.Contains(s.id) && s.codigoEstado == 1 && s.nombre.Contains(filtro))
                                                .OrderBy(s => s.id)
                                                .Skip((page - 1) * size)
                                                .Take(size)
                                                .ToList();
            ...
            else
            {
                if(orden == 1)
                {
                    if(!ascd)
                    {
                        lista = this.context.PortalTransversals.Where(s => !vinculadas.Contains(s.id) && s.codigoEstado == 1)
                                                .OrderBy(s => s.id)
                                                .Skip((page - 1) * size)
                                                .Take(size)
                                                .ToList();
        ...
        public long VincularPortalTransversalTotal(int id, int tipo, string filtro)
        {
            ...
            {
                int idFiltro = int.Parse(filtro);                
                contador = this.context.PortalTransversals.Count(s => !vinculadas.Contains(s.id) && s.codigoEstado == 1 && s.id == idFiltro);
            }
            else if(tipo == 2)
            {
                contador = this.context.PortalTransversals.Count(s => !vinculadas.Contains(s.id) && s.codigoEstado == 1 && s.nombre.Contains(filtro));
            }
            else
            {
                contador = this.context.PortalTransversals.Count(s => !vinculadas.Contains(s.id) && s.codigoEstado == 1);
            }
            return contador;
        }
        ...
        public IList<ElementosUnion> TodosElementos(int id)
        {
            ...
            var vinculadas = this.context.ElementoSubcategorias.Where(s => s.subcategoriaId == id && s.tipoElementoId == elemento1.id && s.codigoEstado == 1).Select(s => s.elementoId).ToList();
            ...
            var vinculadas1 = this.context.ElementoSubcategorias.Where(s => s.subcategoriaId == id && s.tipoElementoId == elemento2.id && s.codigoEstado == 1).Select(s => s.elementoId).ToList();
            ...
            var vinculadas2 = this.context.ElementoSubcategorias.Where(s => s.subcategoriaId == id && s.tipoElementoId == elemento3.id && s.codigoEstado == 1).Select(s => s.elementoId.ToString()).ToList();
            ...
            var vinculadas3 = this.context.ElementoSubcategorias.Where(s => s.subcategoriaId == id && s.tipoElementoId == elemento4.id && s.codigoEstado == 1).Select(s => s.elementoId).ToList();
            ...
            var vinculadas5 = this.context.SubcategoriaCtgSuits.Where(s => s.idSubcategoria == id && s.codigoEstado == 1).Select(s => s.idCategoriaSuit).ToList();
        ...
        public long totalTodos(int id)
        {
            ...
            var vinculadas = this.context.ElementoSubcategorias.Count(s => s.subcategoriaId == id && s.tipoElementoId == elemento1.id && s.codigoEstado == 1);

            var vinculadas1 = this.context.ElementoSubcategorias.Count(s => s.subcategoriaId == id && s.tipoElementoId == elemento2.id && s.codigoEstado == 1);

            var vinculadas2 = this.context.ElementoSubcategorias.Where(s => s.subcategoriaId == id && s.tipoElementoId == elemento3.id && s.codigoEstado == 1).Select(s => s.elementoId.ToString()).ToList();
            long TramiteServicios = vinculadas2.Count();

            var vinculadas3 = this.context.ElementoSubcategorias.Count(s => s.subcategoriaId == id && s.tipoElementoId == elemento4.id && s.codigoEstado == 1);

            var vinculadas4 = this.context.VncSubcategoriaRecursos.Count(s => s.idSubCtg == id && s.codigoEstado == 1);
