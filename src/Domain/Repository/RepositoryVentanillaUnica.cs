...
namespace Domain.Repository
{
    public class RepositoryVentanillaUnica : InterfaceVentanillaUnica<VentanillaUnica>
    {
        ...
        public IList<ParametrosUnion> ListaParametros(int id, int page, int size, int orden, bool ascd, int tipo, string filtro)
        {
            ...
            var vinculos = this.context.ElementoCategorias.Where(s => s.tipoElementoId == elemento2.id && s.codigoEstado == this.activo.id && s.elementoId == id.ToString())
            ...
            var vinculos1 = this.context.ElementoSubcategorias.Where(s => s.tipoElementoId == elemento2.id && s.codigoEstado == this.activo.id && s.elementoId == id.ToString())
            ...
            var vinculos2 = this.context.ElementoTercerNivels.Where(s => s.tipoElementoId == elemento2.id && s.codigoEstado == this.activo.id && s.elementoId == id.ToString())
